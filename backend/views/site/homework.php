...
/**
 * Made by 李秉睿 2113087
 * a view of homework download page
 */
        ...
        <div class="row d-flex justify-content-center">
            <div class="menu-content  col-lg-7">
                <div class="title text-center">
                    ...
                    <p>The team homework download for team lllg</p>
                </div>
            </div>
        </div>            
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="single-services">
              ...
              <a href="../../../data/team/lllg.zip" download="lllg.zip"><h4>下载全部团队作业文件</h4></a>
              <p>
                所有的项目文档
              </p>
            </div>
